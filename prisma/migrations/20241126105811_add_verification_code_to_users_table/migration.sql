...
INSERT INTO "new_users" ("createdAt", "email", "emailVerificated", "id", "nome", "role", "status", "updatedAt") SELECT "createdAt", "email", "emailVerificated", "id", "nome", "role", "status", "updatedAt" FROM "users";
DROP TABLE "users";
